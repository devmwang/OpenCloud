            ...
            <div className="mb-6">
                <div className="-mx-3 flex items-center text-3xl font-semibold">
                    <div className="flex items-center">
                        <div className="cursor-default rounded-xl pt-0.5 pr-3 pb-1 pl-2.5">{"Files"}</div>
                        <div className="block">
                    ...
                    <div className="flex items-center">
                        <div className="relative mr-3 ml-2.5 h-10 w-40 cursor-default overflow-hidden rounded-xl bg-zinc-900 pt-0.5 pb-1 before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_2s_infinite] before:border-t before:border-zinc-700/40 before:bg-gradient-to-r before:from-transparent before:via-zinc-700/40 before:to-transparent"></div>
                        <div className="block">
                            <ChevronRight className="mt-0.5 h-6" />
                        </div>
                    </div>
