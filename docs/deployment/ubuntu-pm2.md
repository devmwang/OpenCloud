...
Do not run `pm2 resurrect` or start either application by hand after a failed migration. The retry repeats the selected build and migration before it starts the selected process set.
